...
open class NetInterface : CustomStringConvertible, CustomDebugStringConvertible {
     ...
     */
    public static func allInterfaces() -> [NetInterface] {
    ...
    convenience init(data:ifaddrs) {
        ...
        self.init(name: String(cString: data.ifa_name),
            ...
            address: NetInterface.extractAddress(data.ifa_addr),
            netmask: NetInterface.extractAddress(data.ifa_netmask),
            ...
            broadcastAddress: ((broadcastValid && destinationAddress(data) != nil) ? NetInterface.extractAddress(destinationAddress(data)) : nil))
    }
...
#if swift(>=5)
extension NetInterface: Identifiable {}
#endif
